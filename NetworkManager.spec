...
%changelog
* Sun Nov 28 2021 gaoxingwang <gaoxingwang@huawei.com> - 1.26.2-10
- Type:bugfix
- ID:NA
- SUG:NA
- DESC:backport patches to fix crash in nm_wildcard_match_check and fix leak of NMOvsdbPrivate.db_uuid

* Sun Nov 7 2021 gaoxingwang <gaoxingwang@huawei.com> - 1.26.2-9
- Type:bugfix
- ID:NA
- SUG:NA
- DESC:libnm: fix leak and return "failures" from nm_client_load_connections()

* Thu Sep 23 2021 gaoxingwang <gaoxingwang@huawei.com> - 1.26.2-8
- Type:bugfix
- ID:NA
- SUG:NA
- DESC:remove rpath

* Thu Aug 5 2021 gaoxingwang <gaoxingwang@huawei.com> - 1.26.2-7
- Type:bugfix
- ID:NA
- SUG:NA
- DESC:amend edit translation of nmcli

* Tue Aug 3 2021 gaoxingwang <gaoxingwang@huawei.com> - 1.26.2-6
- Type:bugfix
- ID:NA
- SUG:NA
- DESC:sync from upstream, fix wrongly considering ipv6.may-fail for ipv4

* Tue Jul 27 2021 gaoxingwang <gaoxingwang@huawei.com> - 1.26.2-5
- Type:bugfix
- ID:NA
- SUG:NA
...
* Thu Sep 24 2020 zhouyihang <zhouyihang3@huawei.com> - 1.26.2-3
- Type:bugfix
- ID:NA
- SUG:NA
- DESC:add attribute noreplace for NetworkManager.conf

* Fri Sep 11 2020 yuboyun <yuboyun@huawei.com> - 1.26.2-2
- Type:bugfix
- ID:NA
- SUG:NA
