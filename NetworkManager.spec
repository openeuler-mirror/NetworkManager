...
Patch9:           backport-libnm-fix-leak-and-return-failures-from-nm-client-load-connections.patch
...
%changelog
* Mon Feb 7 2022 chxssg <chxssg@qq.com> - 1.26.2-3
- Type:bugfix
- ID:NA
- SUG:NA
...
- ID:NA
- SUG:NA
- DESC:update NetworkManger to 1.26.2

* Thu Nov 18 2021 gaoxingwang <gaoxingwang@huawei.com> - 1.26.0-9
- Type:bugfix
- ID:NA
- SUG:NA
- DESC:fix bluetooth,wifi,ovs,ppp module install problem

* Thu Nov 11 2021 zengweifeng<zwfeng@huawei.com> - 1.26.0-8
- Type:bugfix
- ID:NA
- SUG:NA
- DESC: fix use after free

* Sat Oct 30 2021 zhongxuan2<zhongxuan2@huawei.com> - 1.26.0-7
- Type:bugfix
- ID:NA
- SUG:NA
- DESC: decoupling bluetooth,wifi,ovs,ppp module

* Thu Apr 29 2021 zengweifeng<zwfeng@huawei.com> - 1.26.0-6
- Type:bugfix
- ID:NA
- SUG:NA
